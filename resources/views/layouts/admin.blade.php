...
<nav class="bg-white border-b border-or-200 sticky top-0 z-50" style="border-color:#FAD9B5;">
    <div class="px-8 h-[60px] flex items-center gap-2">
        <div class="flex items-center gap-2.5 flex-1">
            <div class="w-8 h-8 rounded-full flex items-center justify-center text-white text-sm" style="background:#C45E08;">
                <img src="/images/lekki-logo.png" alt="">
            </div>
            <span class="cg text-xl font-semibold" style="color:#1E1208;">Sunday Service Attendance Dashboard</span>
        </div>
